/**
  * @namespace
  * @description Vigenere - Object for Vigenere ciphers
  * @type {object}
  */
function Vigenere() {
...
const vigenereMe = new Vigenere();

const myCipher = vigenereMe.encrypt("This is my super secret message.", "tqbfjotld");
const myPlaintext = vigenereMe.decrypt(myCipher, "tqbfjotld");

console.log(`myCipher - ${myCipher}`);
console.log(`myPlaintext - ${myPlaintext}`);
